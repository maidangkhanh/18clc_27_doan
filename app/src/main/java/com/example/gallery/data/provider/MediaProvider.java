package com.example.gallery.data.provider;
...
import com.example.gallery.data.provider.retriever.MediaStoreRetriever;
import com.example.gallery.data.Settings;
import com.example.gallery.data.provider.retriever.StorageRetriever;
