...
import com.example.gallery.data.fileOperations.Move;
import com.example.gallery.data.models.VirtualAlbum;
import com.example.gallery.themes.Theme;
import com.example.gallery.adapter.SelectorModeManager;
import com.example.gallery.adapter.album.AlbumAdapter;
import com.example.gallery.data.models.Album;
import com.example.gallery.data.models.AlbumItem;
import com.example.gallery.data.fileOperations.FileOperation;
import com.example.gallery.data.fileOperations.Rename;
import com.example.gallery.data.models.File_POJO;
import com.example.gallery.data.provider.MediaProvider;
import com.example.gallery.data.provider.Provider;
import com.example.gallery.data.Settings;
import com.example.gallery.ui.widget.FastScrollerRecyclerView;
import com.example.gallery.ui.widget.GridMarginDecoration;
import com.example.gallery.ui.widget.SwipeBackCoordinatorLayout;
import com.example.gallery.util.SortUtil;
import com.example.gallery.util.StorageUtil;
import com.example.gallery.util.animators.ColorFade;
...
public class AlbumActivity extends ThemeableActivity
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        if (!pick_photos) {
            ...
            if (toolbar != null) {
                toolbar.setTitle(allowMultiple ? getString(R.string.pick_photos) :
