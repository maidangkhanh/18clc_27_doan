...
import com.example.gallery.adapter.item.InfoRecyclerViewAdapter;
import com.example.gallery.adapter.item.viewHolder.ViewHolder;
import com.example.gallery.adapter.item.ItemAdapter;
...
import com.example.gallery.data.models.Photo;
...
import com.example.gallery.util.ParallaxTransformer;
import com.example.gallery.util.animators.ColorFade;
import com.example.gallery.util.MediaType;
import com.example.gallery.util.SimpleTransitionListener;
