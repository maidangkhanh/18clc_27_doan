...
import com.example.gallery.ui.FileOperationDialogActivity;
import com.example.gallery.ui.widget.EqualSpacesItemDecoration;
...
public class NestedRecyclerViewAlbumHolder extends AlbumHolder
    ...
    private static class SelectorModeUtil {
        ...
        static Toolbar getSelectorModeToolbar(Context context,
            ...
            int accentColor = theme.getTextColorPrimary(context);
